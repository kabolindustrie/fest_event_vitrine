...
export const jeuxGonflables: JeuGonflable[] = [
  ...
  {
    id: 17,
    titre: "Piscine à Balle",
    slug: "piscine-a-balle",
    images: ["/images/piscineaballe.png"],
    descriptionCourte: "Une piscine remplie de balles colorées pour le plaisir des petits !",
    descriptionLongue: "Une piscine gonflable circulaire remplie de centaines de balles colorées. Idéale pour les tout-petits, elle permet de jouer et de se défouler en toute sécurité.",
    tarif: 180,
  ...
  },
  {
    ...
    tarif: 300,
    dimensions: "11 x 3.5 x 5.5 m",
    age: "",
    categories: ["toboggan", "enfant"],
  },
  {
    id: 19,
    titre: "Parcours Color Géant",
    slug: "parcourscolorgeant",
    images: ["/images/parcourscolorgeant.png"],
    descriptionCourte: "Un parcours géant pour les grands événements !",
    descriptionLongue: "Ce parcours gonflable XXL propose une succession d'obstacles, de tunnels et de glissades sur 22 mètres. Idéal pour les festivals, écoles ou centres de loisirs.",
    tarif: 460,
    dimensions: "22 m de long",
    age: "",
    categories: ["parcours", "toboggan"],
  },
  {
    ...
    titre: "Château Fort",
    slug: "chateauxfort",
    images: ["/images/chateauxfort.png", "/images/chateauxfort2.png"],
    descriptionCourte: "Un véritable petit château fort pour jouer aux chevaliers !",
    descriptionLongue: "Le château fort gonflable offre une structure compacte mais très amusante pour les petits aventuriers.",
    tarif: 200,
    dimensions: "5 x 4 m",
    age: "à partir de 3 ans",
    categories: ["chateau", "enfant"],
